             ...
             Stack(
               children: [
                 ...
                 Row(
                   ...
                   children: [
                     const ItemDetailProductsStore(nameStore: "Điện máy xanh",timeEnd: "11:00",timeStart: "7:00",addressStore: "451 Lê Văn Việt, Tăng Nhơn Phú A, Tp Thủ Đức, Tp Hồ Chí Minh"),
                     Container(
                  ...
                  Row(
                   crossAxisAlignment: CrossAxisAlignment.start,
                   children: [
                     IconButton(onPressed: (){}, icon: const Icon(FontAwesomeIcons.fill)),
                     TextButton(
                       onPressed: () {},
                       child: Wrap(
...
class ItemDetailProductsStore extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: k14Padding,vertical: k12Padding*4),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const SizedBox(height: k20Padding,),
              Text("$nameStore ",style: const TextStyle(color: Colors.deepOrangeAccent,fontSize: k24Padding)),
